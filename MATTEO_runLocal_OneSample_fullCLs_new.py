    ...
    if options.oneSample:
       if sample==options.sample:
                ...
                if options.batchMode:
                   ...
                   pMKLim = subprocess.Popen(['python','MATTEO_makeROOTfile_new.py','--sample',sample,'--mass',mass_str,'--batchMode']);
                   ...
                   pMKLim = subprocess.Popen(['python','MATTEO_makeROOTfile_new.py','--sample',sample,'--mass',mass_str]);
