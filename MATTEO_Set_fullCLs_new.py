       ...
       for lumi_float_value in Luminosities:
           ...
           for CutValue in CutInputVector:
               ...
               if options.copyFILE:
                  ...
                  fileName1="MATTEO_runLocal_OneSample_fullCLs_new.py";
                  fileName2="MATTEO_makeROOTfile_new.py";
                  fileName3="MATTEO_runBatch_FullCLs_new.py";
                  fileName4="MATTEO_extract_FullCLsLimit.py";
                  fileName5="MATTEO_extractLimit_fullCLs_batch.py";
                  fileName6="MATTEO_runMEAN.py";
                  fileName7="MATTEO_runMEAN_batch.py";
                  ...
                  for sm in Sample:
                      ...
                      FinalFileName4=datacards_dir_out+"/cards_em_HP_VBF/%s/"%(sm)+fileName4;
                      FinalFileName5=datacards_dir_out+"/cards_em_HP_VBF/%s/"%(sm)+fileName5;
                      FinalFileName6=datacards_dir_out+"/cards_em_HP_VBF/%s/"%(sm)+fileName6;
                      FinalFileName7=datacards_dir_out+"/cards_em_HP_VBF/%s/"%(sm)+fileName7;
                      ...
                      pCfile4 = subprocess.Popen(['cp',fileName4,FinalFileName4]);
                      pCfile4.wait();    
                      
                      pCfile5 = subprocess.Popen(['cp',fileName5,FinalFileName5]);
                      pCfile5.wait();      
                      
                      pCfile6 = subprocess.Popen(['cp',fileName6,FinalFileName6]);
                      pCfile6.wait();               
                      
                      pCfile7 = subprocess.Popen(['cp',fileName7,FinalFileName7]);
                      pCfile7.wait();    
                      ...
                      tmp_string=["COPY FILES",
                              ...
                              " ",
                              "Copy File 4 from: %s"%fileName4,
                              " ",
                              "Copy File 4 to: %s"%FinalFileName4,
                              " ",
                              "Copy File 5 from: %s"%fileName5,
                              " ",
                              "Copy File 5 to: %s"%FinalFileName5,
                              " ",
                              "Copy File 6 from: %s"%fileName6,
                              " ",
                              "Copy File 6 to: %s"%FinalFileName6,
                              " ",
                              "Copy File 7 from: %s"%fileName7,
                              " ",
                              "Copy File 7 to: %s"%FinalFileName7];
                      print_lined_string_File(tmp_string,SummaryFile);
